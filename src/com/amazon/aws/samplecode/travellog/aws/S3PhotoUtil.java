...
public class S3PhotoUtil {
    ...
    private static String storeThumbnail (Photo photo, byte [] photoData) throws IOException {
        ...
        String name = createName(photo.getTitle());

        TravelLogStorageObject obj = getStorageObject(thumbnail,name+THUMB_SUFFIX);
        S3StorageManager mgr = new S3StorageManager();
    ...
    private static String createName(String title) {
