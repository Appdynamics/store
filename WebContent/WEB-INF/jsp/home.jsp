...
(function(config){
    ...
    config.beaconUrlHttp = 'http://pm2.appdynamics.com';
    config.beaconUrlHttps = 'https://col.eum-appdynamics.com';
    config.xd = {enable : true};
})(window['adrum-config'] || (window['adrum-config'] = {}));
if ('https:' === document.location.protocol) {
    document.write(unescape('%3Cscript')
 + " src='https://cdn.appdynamics.com/adrum/adrum-4.4.2.452.js' "
 + " type='text/javascript' charset='UTF-8'"
 + unescape('%3E%3C/script%3E'));
} else {
    document.write(unescape('%3Cscript')
 + " src='http://cdn.appdynamics.com/adrum/adrum-4.4.2.452.js' "
 + " type='text/javascript' charset='UTF-8'"
 + unescape('%3E%3C/script%3E'));
}
</script>
      ...
      <div id="main">
        <div id="header">
          ...
          <div id="actions">
            ...
            <sec:authorize ifAllGranted="ROLE_ADMIN">
             <a id="deleteJournal" href="javascript:" onclick="deleteJournal()">Delete Journal</a>
            <span class="sep"> | </span>
            <div class="signOut">
